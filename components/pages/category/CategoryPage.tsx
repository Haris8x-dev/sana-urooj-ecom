      ...
      <div className="w-full py-8 px-6">
        {loading ? (
          <div className="flex justify-center items-center h-64">
            <p className="text-gray-400 tracking-widest text-sm animate-pulse uppercase">Loading {categoryTitle}...</p>
          </div>
        ) : products.length === 0 ? (
            <div className="flex justify-center items-center h-64 text-center flex-col gap-2">
                <p className="text-gray-400 tracking-widest text-sm uppercase">No items found in this category</p>
            </div>
        ) : (
          <div
                  ...
                  {gridCols !== 6 && (
                    <div className="mt-4 text-center space-y-1 px-1">
                      <Link href={`/product/${product._id}`}>
                        <h3 className="text-xs font-medium tracking-widest text-gray-900 uppercase hover:text-gray-500 transition-colors line-clamp-1">
                          {product.title}
                        </h3>
                      </Link>
